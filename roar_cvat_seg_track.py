...
#set parameters for video for input and output
video_name = 'cell'
io_args = {
...
###Tune same for good first frame initialization
...
def main():
    print("Takes in arguments: photo_dir: string of path to photo directory, annotation_dir: string of path to annotation directory, \
          output_dir: string path to output directory")
    
frame_idx = 
segtracker = RoarSegTracker(segtracker_args,sam_args,aot_args)
...
###Generate results for whole video
