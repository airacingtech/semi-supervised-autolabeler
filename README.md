...
2. Clone the repository and install the python environment
...
In the root directory run (make sure you always runs `roar_server.py` after the celery workers):
...
- **HOW TO USE:**
  ...
  - [Demonstration Video](https://github.com/airacingtech/roar-seg-and-track-anything/assets/83838942/d4078540-2677-41d6-9b75-ef6466563bfc)
